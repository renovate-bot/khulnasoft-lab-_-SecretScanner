...
const config = {
  title: 'Khulnasoft SecretScanner',
  tagline: 'Find secrets and passwords in container images and file systems',
  url: 'https://secretscanner.local',
  baseUrl: '/',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/khulnasoft-lab/SecretScanner/docs/',
          breadcrumbs: true,
          routeBasePath: '/',
